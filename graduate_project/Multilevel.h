...
public:
	...
	double outEdgeValueLeft;
	double outEdgeValueRight;
	double innerEdgeValueLeft;
	double innerEdgeValueRight;

	void doPartition(CHypergraph *p,int *hcut);
	void myPartition(CHypergraph *p,int *hcut,double AllEdgeValue,double ksize);
